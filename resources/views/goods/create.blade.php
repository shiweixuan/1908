...
<form action="{{url('/goods/store')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="firstname" 
				   placeholder="请输入商品货号" name="g_num">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="firstname" 
				   placeholder="请输入商品价格" name="g_price">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="firstname" 
				   placeholder="请输入商品库存" name="g_number">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="radio"  id="firstname" value="1" name="is_best">是
			<input type="radio"  id="firstname" value="2" name="is_best" checked>否
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="radio"  id="firstname" value="1" name="is_hot">是
			<input type="radio"  id="firstname" value="2" name="is_hot" checked>否
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<textarea class="form-control" id="lastname" name="g_describe"></textarea>
		</div>
	</div>
