    ...
    @section('content')
     ...
     <ul class="pronav">
      @foreach($data as $v)
      <li><a href="{{url('/cate/'.$v->cid)}}">{{$v->cname}}</a></li>
      @endforeach
      <div class="clearfix"></div>
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/proinfo/'.$v->g_id)}}"><img src="{{env('UPLOAD_URL')}}{{$v->g_img}}" /></a></dt>
        <dd class="ip-text"><a href="{{url('/proinfo/'.$v->g_id)}}">{{$v->g_name}}</a><span>库存：{{$v->g_number}}</span></dd>
     ...
     <div class="prolist">
      ...
      <!-- <dl>
       ...
       <dd>
        <h3><a href="proinfo.html"></a></h3>
        <div class="prolist-price"><strong>¥{</strong> <span>¥599</span></div>
        <div class="prolist-yishou"><span>5.0折</span> <em>库存：</em></div>
       </dd>
       <div class="clearfix"></div>
      </dl> -->
